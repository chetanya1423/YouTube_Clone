...
import { faMicrophone,faSearch,faCamera,faClose } from "@fortawesome/free-solid-svg-icons";
    ...
    <div className="w-full flex flex-col">
      <div className="w-full flex">
        ...
        <div className="md:w-[20%] w-[50%] flex justify-end items-center">
          ...
          >
            {showNav ? (
                <FontAwesomeIcon icon={faClose} className="text-xl relative top-1"/>
            ) : (
                <FontAwesomeIcon icon={faSearch} className="text-xl relative top-1"/>
            )}
          </div>
